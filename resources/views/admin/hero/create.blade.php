@extends('layouts.app')
@section('title', 'Create Hero Text')
@section('content')
<div class="p-6 bg-gray-50 min-h-screen">
    <h2 class="text-2xl font-bold mb-6">Add New Hero Text</h2>

    <form action="{{ route('admin.hero.store') }}" method="POST" class="bg-white p-6 rounded shadow space-y-4">
        @csrf
